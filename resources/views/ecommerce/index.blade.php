			...
			<div class="container">
				<div class="banner_content row">
					<div class="offset-lg-2 col-lg-8">
						<h1>coffe creates imagination
							
						<p>everyday like sunday</p>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="main_title">
						...
						<p>Ga hanya kopi banyak yang lain juga</p>
					</div>
				</div>
				<div class="row ">
					...
					<div class="col col1">
						<div class="f_p_item">
							<div class="f_p_img bg-light">
                                <img class="img-fluid "   height="150px" 
                                                        width="150px" src="{{ asset('public/storage/products/' . $row->image) }}" alt="{{ $row->name }}">
								<div class="p_icon">
